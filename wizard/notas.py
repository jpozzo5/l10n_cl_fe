...
class AccountInvoiceRefund(models.TransientModel):
    ...
    note_id = fields.Many2one('pos.order.reason.nc', 'Motivo')
    
    @api.onchange('note_id',)
    def onchange_note_id(self):
        self.description = self.note_id.name or ''
    ...
    @api.multi
    def _set_fields_aditional_refund(self):
        return {}
        ...
        for form in self:
            ...
            for inv in inv_obj.browse(context.get('active_ids')):
                ...
                if mode in ['2']:
                    ...
                    invoice.update(form._set_fields_aditional_refund())
                ...
                xml_id = refund.type == 'out_refund' and 'action_invoice_out_refund' or \
                         ...
                         refund.type == 'in_invoice' and 'action_vendor_bill_template'
